...
if text_:match("^[!/#](م1)") and is_sudo(msg) then
      local text1 = [[
...
- المطور ،♥️' :- @amody7]]
return tdcli.sendMessage(msg.chat_id_, 0, 1, text1, 1, "")
	  if text_:match("^[!/#](م2)") and is_sudo(msg) then
      local text1 = [[
اهلا صديقي في قائمة. الارسال جميع الاوامر تعمل ب (/#!)
...
- المطور ،♥️' :- @amody7]]
return tdcli.sendMessage(msg.chat_id_, 0, 1, text1, 1, "")
if text_:match("^[!/#](م3)") and is_sudo(msg) then
...
if text_:match("^[!/#](م4)") and is_sudo(msg) then
      local text1 = [[
/معلومات
